...
//     void SetUp() override {
//         history_over_time[0] =
//         HistoryStamp{Eigen::VectorXd::Constant(4, 3.0),
//                                             Eigen::VectorXd::Constant(4, 2.0),
//                                             Eigen::VectorXd::Constant(4, 1.0)};
//         history_over_time[1] =
//         HistoryStamp{Eigen::VectorXd::Constant(4, 4.0),
//                                             Eigen::VectorXd::Constant(4, 3.0),
//                                             Eigen::VectorXd::Constant(4, 2.0)};
//         history_over_time[2] =
//         HistoryStamp{Eigen::VectorXd::Constant(4, 5.0),
...
//     auto result =
//         StampUtilitiesOverTime(history_over_time, utility,
//         UtilityType::kMin);
...
//         history_over_time, {"Perspective1", "Perspective2"},
//         healthcare_costs, aod_costs, fod_costs, pharma_costs,
//         treatment_costs);
