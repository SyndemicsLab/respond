...
When we assume \f$x_{t}\f$ is able to represent the state of the cohort at timestep \f$t\f$, this means that the model is concerned with representing the transition matrix \f$M\f$. RESPOND represents this transition matrix as a series of sequential operations. They are:

1. Entering Cohort Transitions
2. Behavior Transitions
3. Intervention Transitions
4. Behavior Transitions Post Intervention Transition
5. Overdose Transitions
6. Background Mortality Transitions
