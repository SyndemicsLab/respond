...
public:
    ...
    virtual void AddTransition(std::unique_ptr<Transition>) = 0;
    ...
    virtual const std::vector<History> &GetHistories() const = 0;

    virtual void SetHistories(const std::vector<History> &h) = 0;
