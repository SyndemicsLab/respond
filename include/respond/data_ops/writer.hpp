...
namespace respond::data_ops {
    ...
    public:
        ...
        virtual std::string
        WriteInputData(const DataLoader &data_loader,
        ...
        WriteHistoryData(const History &history, const std::string &directory,
                         const OutputType output_type) const = 0;
        virtual std::string
        WriteCostData(const CostList &cost_list, const std::string &directory,
                      const OutputType output_type) const = 0;
        virtual std::string
        WriteUtilityData(const TimedMatrix3d &utilities,
                         ...
                         const OutputType output_type) const = 0;
        virtual std::string
        WriteTotalsData(const Totals &totals, const std::string &directory,
                        const OutputType output_type) const = 0;
