...
public:
    ...
    /// @param mortalityRates Matrix3d of Mortality Rates
    virtual void
    LoadTransitionModules(Data::Matrix3dOverTime enteringSamples,
...
public:
    ...
    void
    loadInterventionInitRates(Data::Matrix3d interventionInitRates) override;
    ...
    void
    loadFatalOverdoseRates(Data::Matrix3dOverTime fatalOverdoseRates) override;
