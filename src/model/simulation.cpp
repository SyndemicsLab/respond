...
namespace respond::model {
    ...
    Matrix3d RespondImpl::MultiplyBehaviorTransition(
    ...
    Matrix3d RespondImpl::MultiplyUseAfterIntervention(
        const Matrix3d &interventionState, int const intervention_idx,
        const DataLoader &data_loader) const {
    ...
    Matrix3d
    RespondImpl::MultiplyMortality(const Matrix3d &state,
                                   const DataLoader &data_loader) const {
