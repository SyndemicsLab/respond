...
namespace Data {
    ...
    public:
        ...
        int getNumOUDStates() const { return numOUDStates; }

        /// @brief Get Number of Integerventions
        /// @return Integer Number of Interventions
        int getNumInterventions() const { return numInterventions; }

        /// @brief Get the Number of Demographics
        /// @return Integer Number of Demographics
        int getNumDemographics() const { return numDemographics; }

        /// @brief Get the Number of Demographics
        /// @return Integer Number of Demographics
        int getNumDemographicCombos() const { return numDemographicCombos; }
        ...
        Matrix3dOverTime getEnteringSamples() const { return enteringSamples; }
        ...
        std::vector<std::string> getOUDStates() const { return oudStates; }
        ...
        int getAgeGroupShift() const { return ageGroupShift; }
        ...
        bool getCostSwitch() const { return costSwitch; }
        ...
        int getReportingInterval() const;
        ...
        bool getCostCategoryOutputs() const;
        ...
        bool getPerInterventionPredictions() const {
        ...
        bool getGeneralOutputsSwitch() const { return generalOutputsSwitch; }
        ...
        /// print output
        std::vector<int> getGeneralStatsOutputTimesteps() const {
        ...
        /// @return Matrix3dOverTime Overdose Rates
        Matrix3dOverTime loadOverdoseRates(std::string const &csvName);

        /// @brief Load the Fatal Overdose Rates
        /// @param csvName Filename to the Fatal Overdose Rates
        /// @return Matrix3dOverTime Fatal Overdose Rates
        Matrix3dOverTime loadFatalOverdoseRates(std::string const &csvName);
